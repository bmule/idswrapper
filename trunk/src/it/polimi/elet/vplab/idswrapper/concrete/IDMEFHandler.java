...
/**
 * Handles output (i.e., alerts) in IDMEF format.
 */
public class IDMEFHandler
	extends OutputHandler
{
	/**
	 * Creates a new IDMEF handler object.
	 */
	public IDMEFHandler()
	{
		handlerName = "IDMEF Handler";
		handlerType = "IDEMF output handler";
			
		Main.logger.info("Starting " + handlerName + ": " + handlerType);
	}
